...
public class PrincipalD {
	...
	public static void main(String[] args){
		...
		startAgents(agentList);
			...
			if(PLATFORM_isMAIN){
				...
				containerList.putAll(createAndConnectContainer("07-IndianaJones", PLATFORM_HOSTNAME, PLATFORM_ID, PLATFORM_PORT));
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		c = containerList.get("07-IndianaJones");
		Assert.assertNotNull("This container does not exist",c);
		agentName="07-MinusEtCortex";
		String gatekeeperName="GK";
		try {
			Object[] objtab=new Object[]{gatekeeperName};//used to give informations to the agent
			AgentController	ag=c.createNewAgent(agentName,mas.agents.MovingIndiana.class.getName(),objtab);
			agentList.add(ag);
